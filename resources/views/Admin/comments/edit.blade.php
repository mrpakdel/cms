        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    <!--begin::Form-->
                    <form action="{{route('contents.update',['content'=>$content->slug])}}" method="post" id="create"  enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right">
                        {{csrf_field()}}
                        {{method_field('PATCH')}}
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <input type="text" class="form-control m-input" id="title" aria-describedby="titleHelp" placeholder="" name="title" value="{{$content->title}}">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <textarea class="form-control m-input" id="description" name="description"  rows="5">{{$content->description}}</textarea>
                            </div>
                            <div class="form-group m-form__group">
                                <label for="">{{__('admin.Description')}} </label>
                                <textarea class="form-control m-input body" id="body" name="body"  rows="5">{{$content->body}}</textarea>
                            </div>
                            <div class="form-group m-form__group">
                                <label for="">{{__('admin.Tags')}}</label>
                                <input type="text" class="form-control m-input" id="tag" aria-describedby="titleHelp" placeholder="" name="tags" value="{{$content->tags}}">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <select  class="form-control m-input " name="lang"  id="exampleSelect2">
                                    <option {{$content->lang == "fa" ? "selected":""}} value="fa">فارسی</option>
                                    <option {{$content->lang == "en" ? "selected":""}} value="en">English</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <form  method="post" action="{{route('dropzone.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="dropzone dz-clickable m-dropzone dropzone m-dropzone--success" id="image-upload">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="img-thumbnail">
                                    <img src="{{$content->image}}" class="img-responsive img-thumbnail" alt="">
                                </div>
