            ...
            <div class="m-portlet__body">
                ...
                <table class="m-datatable" id="html_table" width="100%">
                    ...
                    <tr>
                        ...
                        <th title="Field #3" data-field="Family">{{__('admin.Description')}}</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="m-demo__preview m-demo__preview--btn">
                                    <a href="{{route('permissions.edit' , ['roles'=>$permission->id])}}" class="btn btn-accent m-btn m-btn--icon m-btn--icon-only m-btn--custom ">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <span data-id="{{$permission->id}}"  data-route="$permissions" class="btn btn-danger m-btn m-btn--icon m-btn--icon-only m-btn--custom mt-sweetalert m_sweetalert_demo_9" data-lang="{{$local}}"  data-confirm="{{__('admin.Yes')}}" data-cancel="{{__('admin.No')}}" data-text="{{__('admin.text_delete')}}" data-title="{{__('admin.message_delete')}}" d>
