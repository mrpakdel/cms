            ...
            <div class="m-portlet__body">
                ...
                <table class="m-datatable" id="html_table" width="100%">
                    ...
                    <tr>
                        ...
                        <th title="Field #4" data-field="supplier">{{__('admin.Language')}}</th>
                    ...
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td>
                                <img src="{{$category->image}}" width="100%" class="img-thumbnail img-responsive img-rounded">
                            </td>
                            <td>{{$category->name}}</td>
                            <td>{{$category->lang == "fa" ? "فارسی":"English"}}</td>
                            <td>
                                <div class="m-demo__preview m-demo__preview--btn">
                                    <a href="{{route('categoryProduct.edit' , ['categoryProduct'=>$category->slug])}}" class="btn btn-accent m-btn m-btn--icon m-btn--icon-only m-btn--custom btn-sm">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <span data-id="{{$category->id}}"  data-route="categoryProduct" class="btn btn-danger btn-sm m-btn m-btn--icon m-btn--icon-only m-btn--custom mt-sweetalert m_sweetalert_demo_9" data-lang="{{$local}}"  data-confirm="{{__('admin.Yes')}}" data-cancel="{{__('admin.No')}}" data-text="{{__('admin.text_delete')}}" data-title="{{__('admin.message_delete')}}" >
