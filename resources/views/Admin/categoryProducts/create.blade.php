        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    <!--begin::Form-->
                    <form action="{{route('categoriesProduct.store')}}" method="post" id="create"  enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right">
                        {{csrf_field()}}
                        ...
                        <div class="m-portlet__body " data-code-preview="true" data-code-html="true" data-code-js="false">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <textarea class="form-control m-input summary" id="summary" name="summary"  rows="5">{{old('summary')}}</textarea>
                            </div>
                            <div class="form-group m-form__group">
