                                                    ...
                                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        ...
                                                        <div class="m-form__section m-form__section--first">
                                                            ...
                                                            <div class="form-group m-form__group">
                                                                ...
                                                                <select class="form-control m-select2" id="m_select2_3" name="category_portfolio_id[]" multiple="multiple">
                                                        ...
                                                        <div class="m-form__section">
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                <label class="col-xl-3 col-lg-3 col-form-label">* {{__('admin.technology')}}:</label>
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <input type="text" name="technology" id="technology" class="form-control m-input" placeholder="" value="{{old('technology')}}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
