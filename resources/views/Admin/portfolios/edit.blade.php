                                                    ...
                                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        ...
                                                        <div class="m-form__section m-form__section--first">
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <label class="m-radio m-radio--solid m-radio--brand">
                                                                        <input type="radio" name="is_virtual"  class=" m-input" id="is_" placeholder="" {{$product->is_virtual == 0 ? "checked" : ""}}  >{{__('admin.Standard_product')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="m-radio m-radio--solid m-radio--brand">
                                                                        <input type="radio" name="is_virtual" class=" m-input" placeholder="" {{$product->is_virtual == 1 ? "checked" : ""}}  >{{__('admin.Virtual_product')}}
                                                                        <span></span>
                                                                    </label>
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <input type="text" name="name" class="form-control m-input" id="name" placeholder="" value="{{$product->name}}">
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <input type="text" name="code" class="form-control m-input" placeholder="" value="{{$product->code}}">
                                                                    <span class="m-form__help"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <div class="input-group">
                                                                        <input type="text" name="ean_code" class="form-control m-input" placeholder="" value="{{$product->ean_code}}">
                                                                    </div>
                                                                    <span class="m-form__help"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <div class="input-group">
                                                                        <input type="text" name="upc_code" class="form-control m-input" placeholder="" value="{{$product->upc_code}}">
                                                                    </div>
                                                                    <span class="m-form__help"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <input type="checkbox" data-toggle="toggle" {{$product->status == 1 ? "checked" : ""}} data-on="{{__('admin.Yes')}}" data-off="{{__('admin.No')}}" id="status">
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                <label class="col-xl-3 col-lg-3 col-form-label">* {{__('admin.Type_Of_Show')}}:</label>
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                                                        <input type="checkbox" name="available_for_order" id="available_for_order" class=" m-input" {{$product->available_for_order == 1 ? "checked" : ""}}  placeholder="" >{{__('admin.available_for_order')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                                                        <input type="checkbox" name="show_price" class=" m-input" placeholder="" id="show_price" {{$product->show_price == 1 ? "checked" : ""}} >{{__('admin.show_price')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                                                        <input type="checkbox" name="show_only" id="show_only" class=" m-input" placeholder="" {{$product->show_only == 1 ? "checked" : ""}} >{{__('admin.show_only')}}
                                                                        <span></span>
                                                                    </label>
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <select class="form-control m-input" id="product_status" name="product_status">
                                                                        ...
                                                                        <option value="1" {{$product->product_status == 1 ? "selected" : ""}} >{{__('admin.product_new')}}</option>
                                                                        <option value="2" {{$product->product_status == 2 ? "selected" : ""}} >{{__('admin.product_repaired')}}</option>
                                                                        <option value="3" {{$product->product_status == 3 ? "selected" : ""}} >{{__('admin.product_secondhand')}}</option>
                                                                    </select>
                                                                    <span class="m-form__help"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <select class="form-control m-select2" id="m_select2_3" name="category_product_id[]" multiple="multiple">
                                                                    @foreach($categories as $category)
                                                                        <option value="{{$category->id}}" {{in_array($category->id,$product->category_products->pluck('id')->toArray()) ? "selected" : ""}}>{{$category->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="m-form__section">
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <textarea type="text" name="description" rows="10" itemid="description" id="description" class="form-control m-input" placeholder="" >{{$product->description}}</textarea>
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <textarea type="text" name="body" id="body" class="form-control m-input">{{$product->body}}</textarea>
                                                                    <span class="m-form__help"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <input type="text" name="tags" id="tags" class="form-control m-input" placeholder="" value="{{$product->tags}}">
                                                                </div>
                                                            </div>
                                                            <div class="pull-left m--margin-10-desktop">
                                                                <span  class="btn btn-success m-btn m-btn--custom m-btn--icon update_product" name="update_ajax" product="{{$product->id}}" data-lang="{{$local}}" data-urlBack="{{route("products.index")}}" id="save" >{{__('admin.Save')}}</span>
                                                                <span  class="btn btn-success m-btn m-btn--custom m-btn--icon update_product" name="update_ajax" product="{{$product->id}}" data-lang="{{$local}}" data-urlBack="" id="save_and_stay" >{{__('admin.Saveـandـstay')}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                                        <div class="m-form__section m-form__section--first">
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <input type="text" name="quantity" class="form-control m-input" id="quantity" placeholder="" value="{{$product->quantity}}">
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <input type="text" name="price" class="form-control m-input" id="price" placeholder="" value="{{$product->price}}">
                                                                    <span class="m-form__help" id="quantity_error"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <input type="text" name="WholeSale_price" class="form-control m-input" id="wholesale_price" placeholder="" value="{{$product->wholesale_price}}">
                                                        ...
                                                        <div class="m-separator m-separator--dashed m-separator--lg"></div>
                                                        <div class="pull-left m--margin-10-desktop">
                                                            <span  class="btn btn-success m-btn m-btn--custom m-btn--icon update_product_ajax" product="{{$product->id}}" name="update_ajax" data-lang="{{$local}}" data-urlBack="{{route("products.index")}}" id="save" >{{__('admin.Save')}}</span>
                                                            <span  class="btn btn-success m-btn m-btn--custom m-btn--icon update_product_ajax" product="{{$product->id}}" name="update_ajax" data-lang="{{$local}}" data-urlBack="" id="save_and_stay" >{{__('admin.Saveـandـstay')}}</span>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="m-portlet m-portlet--tab">
                                                            <h3>فایل های خود را  بکشید و در این قسمت رها کنید</h3>
                                                                <div class="file_drag_erea" id="file_drag_area">
                                                                    Drag File Here Or Click Down <i class="fa fa-angle-down"></i>
                                                                    <form action="">
                                                                        <label class="upload-images">
                                                                            <input class="form-control " type="file" name="file[]" id="uplod_img" multiple>
                                                                        </label>
                                                                    </form>
                                                                </div>

                                                            <div id="uploaded_file" class="row data-message_sweet m--padding-10" data-message_sweet="{{__('admin.message_sweet')}}" data-title_sweet="{{__('admin.title_sweet')}}">
                                                                @if($product->images()->count() > 0)
                                                                    @foreach($product->images as $image)

                                                                        <div class="col-md-4 set_image_default m--margin-top-10 m--padding-10" id="{{$image->id}}" style="background: url({{$image->image}})" >

                                                                            <span class="btn {{$image->is_default == 1 ? "btn-danger":"btn-accent"}} ">
                                                                                <i class='fa fa-check-circle'></i>
                                                                            </span>
                                                                            <span class="btn {{$image->is_default == 1 ? "btn-danger":"btn-accent"}}  m_sweetalert_demo_9" data-id="{{$image->id}}" data-route="imagesProduct" data-lang="{{$local}}"  data-confirm="{{__('admin.Yes')}}" data-cancel="{{__('admin.No')}}" data-text="{{__('admin.text_delete')}}" data-title={{__('admin.message_delete')}}  >
                                                    ...
                                                    <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                            ...
                                                            <div class="m-form__section">
                                                                ...
                                                                <div class="pull-left m--margin-10-desktop">
                                                                    <span  class="btn btn-success m-btn m-btn--custom m-btn--icon update_dependencies_ajax" product="{{$product->id}}" name="update_ajax" data-lang="{{$local}}" data-urlBack="{{route("products.index")}}" id="save" >{{__('admin.Save')}}</span>
                                                                    <span  class="btn btn-success m-btn m-btn--custom m-btn--icon update_dependencies_ajax" product="{{$product->id}}" name="update_ajax" data-lang="{{$local}}" data-urlBack="" id="save_and_stay" >{{__('admin.Saveـandـstay')}}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
