        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{route('socials.store')}}" method="post" enctype="multipart/form-data" class="horizontal-form">
                        {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="address" name="address" value="{{old('address')}}" class="form-control" placeholder="{{__('admin.Address')}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="user_name" name="user_name" value="{{old('user_name')}}" class="form-control" placeholder="{{__('admin.User_name')}}">
                                        <span class="help-block">  </span>
                                    </div>
                                </div>
                                <!--/span-->
