            ...
            <div class="m-portlet__body">
                ...
                <table class="m-datatable" id="html_table" width="100%">
                    ...
                    <tr>
                        ...
                        <th title="Field #3" data-field="Contact">{{__('admin.Order')}}</th>
                        <th title="Field #4" data-field="CarMake">{{__('admin.Link')}}</th>
                        <th title="Field #5" data-field="CarModel">{{__('admin.Image')}}</th>
                    ...
                    @foreach($sliders as $slider)
                        <tr>
                            ...
                            <td><img src="{{$slider->image}}" class="img-thumbnail" alt=""></td>
                            <td>{{$slider->lang == 'en' ? 'English' : 'فارسی'}}</td>
                            <td>
                                <div class="m-demo__preview m-demo__preview--btn">
                                    <a href="{{route('sliders.edit' , ['slider'=>$slider->id])}}" class="btn btn-accent m-btn m-btn--icon m-btn--icon-only m-btn--custom ">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <span data-id="{{$slider->id}}"  data-route="sliders" class="btn btn-danger m-btn m-btn--icon m-btn--icon-only m-btn--custom mt-sweetalert m_sweetalert_demo_9" data-lang="{{$local}}"  data-confirm="{{__('admin.Yes')}}" data-cancel="{{__('admin.No')}}" data-text="{{__('admin.text_delete')}}" data-title="{{__('admin.message_delete')}}" d>
